...
PACKAGES=(
  "src/Presentation:AutoMapper:latest"
  "src/Presentation:AutoMapper.Extensions.Microsoft.DependencyInjection:latest"
  "src/Presentation:FluentValidation:latest"
  "src/Presentation:FluentValidation.DependencyInjectionExtensions:latest"
  "src/Presentation:MediatR:latest"
  "src/Presentation:Microsoft.AspNetCore.OpenApilatest"
  "src/Presentation:Microsoft.EntityFrameworkCorelatest"
  "src/Presentation:Microsoft.EntityFrameworkCore.Designlatest"
  "src/Presentation:Microsoft.EntityFrameworkCore.Relationallatest"
  "src/Presentation:Npgsql.EntityFrameworkCore.PostgreSQLlatest"
  "src/Presentation:Serilog.AspNetCorelatest"
  "src/Presentation:Serilog.Settings.Configurationlatest"
  "src/Presentation:Swashbuckle.AspNetCorelatest"

  "src/Application:AutoMapper:latest"
  "src/Application:AutoMapper.Extensions.Microsoft.DependencyInjection:latest"
  "src/Application:FluentValidation:latest"
  "src/Application:FluentValidation.DependencyInjectionExtensions:latest"
  "src/Application:MediatR:latest"

  "src/Domain:MediatR:latest"
  "src/Domain:Microsoft.Extensions.DependencyInjection:latest"

  "src/Infrastructure:AutoMapper:latest"
  "src/Infrastructure:AutoMapper.Extensions.Microsoft.DependencyInjection:latest"
  "src/Infrastructure:MediatR:latest"
  "src/Infrastructure:Microsoft.EntityFrameworkCore:latest"
  "src/Infrastructure:Microsoft.EntityFrameworkCore.Design:latest"
  "src/Infrastructure:Microsoft.EntityFrameworkCore.Relational:latest"
  "src/Infrastructure:Microsoft.Extensions.DependencyInjection:latest"
  "src/Infrastructure:Npgsql.EntityFrameworkCore.PostgreSQL:latest"

  "src/Migrator:Microsoft.Extensions.Configuration:latest"
  "src/Migrator:Microsoft.Extensions.Configuration.Binder:latest"
  "src/Migrator:Microsoft.Extensions.Configuration.Json:latest"
  "src/Migrator:Microsoft.Extensions.DependencyInjection:latest"
  "src/Migrator:Microsoft.Extensions.Logging:latest"
  "src/Migrator:Npgsql:latest"
)
